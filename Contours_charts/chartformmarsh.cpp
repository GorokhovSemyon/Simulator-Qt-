#include "chartformmarsh.h"
#include "ui_chartformmarsh.h"

ChartFormMarsh::ChartFormMarsh(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ChartFormMarsh)
{
    ui->setupUi(this);
    ...
    yAxis->setTitleText("Напряжение марша, В");
...
ChartFormMarsh::~ChartFormMarsh()
{
    delete ui;
}

void ChartFormMarsh::setYT(double Y, int T)
{
